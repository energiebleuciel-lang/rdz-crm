          ...
          <div className="space-y-6">
            ...
            <div className="bg-amber-50 border border-amber-200 rounded-lg p-4">
              ...
              <p className="text-sm text-amber-700 mb-3">
                Choisissez le produit pour générer le script avec l'URL de redirection correspondante (configurée dans le Compte).
              </p>
              ...
              {selectedBriefProduct && (
                <div className="mt-3 text-sm">
                  ...
                  <code className="bg-white px-2 py-1 rounded text-xs">
                    {briefData.redirect_urls?.[selectedBriefProduct.toLowerCase()] || briefData.redirect_urls?.default || briefData.form?.redirect_url || '/merci'}
                  </code>
                  {!briefData.redirect_urls?.[selectedBriefProduct.toLowerCase()] && (
                    <span className="ml-2 text-amber-600 text-xs">(URL par défaut - configurez l'URL {selectedBriefProduct} dans le Compte)</span>
                  )}
                </div>
              )}
            </div>
